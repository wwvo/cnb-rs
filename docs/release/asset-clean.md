...
`--tag-name-prefix <PREFIX>`
: 删除 Tag 名称以指定前缀开头的 Release 的所有附件

`--release-name-prefix <PREFIX>`
: 删除 Release 名称以指定前缀开头的 Release 的所有附件

`--keep-days <N>`
: 删除 N 天前发布的 Release 的附件

`--keep-num <N>`
: 保留最近 N 个有附件的 Release，删除更早的附件
